...
// While the board loops, it calls the findMoves method to find the next move a player in the game is going to make.
//It then calls the checkWin() method to determine who won and prints out
